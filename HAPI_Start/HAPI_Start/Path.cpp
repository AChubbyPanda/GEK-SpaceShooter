...
//These are declared here inorder for the randomPath() and getPoint() to work as using a instance of the Path class was causing a NULL
static int firstPath[22][2] = { {1080,720}, {1080,650}, {1010,650}, {1010, 580}, {940, 580}, {940,510}, {870, 510}, {870,440}, {800, 440}, {800, 370},
	{710,370}, {710, 300}, { 640, 300}, {640, 230}, {570, 230}, {570, 160} , {500, 160}, {500, 90}, {430, 90}, {430, 20}, {360, 20},
	{360, -50} };

//These are declared here inorder for the randomPath() and getPoint() to work as using a instance of the Path class was causing a NULL
static int secondPath[22][2] = { {900, 0}, { 900, 70 }, { 970, 70 }, { 970, 140 }, { 1040, 140 }, { 1040, 210 }, { 1110, 210 }, { 1110, 280 }, { 1040, 280 }, { 1040, 350 }, { 970, 350 }, { 970, 420 },
